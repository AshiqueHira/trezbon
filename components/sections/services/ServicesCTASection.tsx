      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-4 max-w-xl text-sm md:text-base text-gray-200 leading-relaxed">
            Connect with us to discover how Trezbon’s consulting, training, and
            managed services can support your technology goals. Our team takes
            time to understand your challenges and works closely with you to
            recommend solutions that align with your business priorities.
          </p>
